...
class UserProfile(models.Model):
    ...
    default_first_address_line = models.CharField(max_length=80, null=True, blank=True)
    default_second_address_line = models.CharField(max_length=80, null=True, blank=True)
